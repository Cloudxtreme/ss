	...
	<tr>
		<td valign="top">
			<table width="98%" style="font-size:14px;margin:10px;">
				<tr><td height="28px" width="46%" align="right">选择链路：</td><td>
					<select style="width:160px;border:solid 1px #c3d7e3;height:26px;" border="0" type="text" placeholder="链路名称" id="pwd">
						<option>链路一</option>
						<option>链路二</option>
					</select>
				</td></tr>
