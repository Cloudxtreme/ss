#!/bin/bash
#pppoe-server -I em2.2010 -N 62 -L 10.0.0.1 -R 10.18.0.1 -S pppoe-113 -k
#pppoe-server -I em2.2011 -N 62 -L 10.0.0.1 -R 10.18.0.65 -S pppoe-113 -k
#pppoe-server -I em2.2012 -N 62 -L 10.0.0.1 -R 10.18.0.129 -S pppoe-113 -k
#pppoe-server -I em2.2013 -N 62 -L 10.0.0.1 -R 10.18.0.193 -S pppoe-113 -k
#pppoe-server -I em2.2014 -N 62 -L 10.0.0.1 -R 10.18.1.1 -S pppoe-113 -k
#pppoe-server -I em2.2015 -N 62 -L 10.0.0.1 -R 10.18.1.65 -S pppoe-113 -k
#pppoe-server -I em2.2016 -N 62 -L 10.0.0.1 -R 10.18.1.129 -S pppoe-113 -k
#pppoe-server -I em2.2017 -N 62 -L 10.0.0.1 -R 10.18.1.193 -S pppoe-113 -k
#pppoe-server -I em2.2018 -N 62 -L 10.0.0.1 -R 10.18.2.1 -S pppoe-113 -k
#pppoe-server -I em2.2019 -N 62 -L 10.0.0.1 -R 10.18.2.65 -S pppoe-113 -k
