...
<script src="../js/web.referrer.js" type="text/javascript"></script>
...
<script>jQuery(function(){flexMenu('box')})</script> <!--左导航结束--></div>
		<div class="main_right">
			...
			<div id="content" class="main_right_middle">
				<div class="search">
					<form name="queryF" method="post" action="referrer.action" onsubmit="return query()">
						<div class="search_left">
							<table>
								...
								<tr>
									...
									<td class="channel">
										<select id="channel" multiple="multiple" size="${size}" name="selectedChannels" size=1></select>
					...
					<div class="content">
						<div class="subtitle">
							<h2>TOP10 来源网站按请求数排行</h2>
							<span class="more"></span>
						</div>
						<div class="table">
							<table id="web_request_table">
								<tr>
									<th width="30px" class="index">序号</th>
									<th width="200px" class="center">来源网站
											<img id="tt_web_type" src="data:image/png;base64,">
										<script>$(document).ready(function(){$("#tt_web_type").tooltip({position:"center right",tip:"#tt_web"})});</script></th>
									<th width="140px">流量</th>
									<th width="140px">请求数</th>
					...
					<div class="content">
						<div class="subtitle">
							<h2>TOP10 搜索引擎按请求数排行 </h2>
						</div>
						<div class="table">
							<table id="search_request_table">
								<tr>
									<th width="30px" class="index">序号</th>
									<th width="180px">搜索引擎</th>
									<th width="220px">流量</th>
									<th class="last">请求数</th>
								</tr>
					...
					<div class="content">
						<div class="subtitle">
							<h2>TOP10 搜索关键字按搜索次数排行</h2>
						</div>
						<div class="table">
							<table id="key_request_table">
								<tr>
									<th width="30px" class="index">序号</th>
									<th width="180px">搜索关键字</th>
									<th width="220px">流量</th>
									<th class="last">请求数</th>
								</tr>
