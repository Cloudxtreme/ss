...
<script src="../js/file.performance.js" type="text/javascript"></script>
...
<div class="tab" id="menuDIV1">
	<ul id="menuUL1">
       	<li class='YKTabsOn'><a href='javascript:void()'>性能分析</a></li>
        <li ><a href='downanalyse.php'>下载分析</a></li>
    </ul>
</div>
				...
				<div class="search">
					...
					<div class="content">
						...
						<div class="table">
							<table id="_channel_rate_table">
								<tr>
									<th width="30px" class="index">序号</th>
									<th width="180px">频道名称</th>
									<th width="180px">平均下载速度(KBps)</th>
									<th class="last">地区详情</th>
								</tr>
					...
					<div class="content" >
						<div class="subtitle">
							<h2><span id="span_channel"  style="color:red"></span>频道在各下载区间中的请求数的统计(单位:KBps)</h2>
					...
					<div class="content">
						<div class="subtitle">
							<h2>频道在各下载区间中的请求数的统计(单位:KBps)</h2>
						
						</div>
						<div class="table">
							<table id="_channel_request_count">
								<tr>
									<th width="30px" class="index">序号</th>
									<th width="180px">频道名称</th>
									<th width="180px">0-50</th>
									<th width="180px">50-100</th>
									<th width="180px">100-200</th>
									<th width="180px">200-500</th>
									<th width="180px">500-1024</th>
									<th width="180px">1024以上</th>
								</tr>
