...
<script src="../js/base.dns.js" type="text/javascript"></script>
		...
		<div class="main_right">
			...
			<div id="content" class="main_right_middle">
						...
						<div class="search_left">
							<table>
								<tr>
									...
									<td style="width:60px;">子域名：</td>
									<td>
										<input name="domain" id="domain" type="text" style="width:180px;">
									</td>
										<td></td>
								...
								<!--	<td>网络类型：</td>
									<td>
										<select id="nettype" style="width:80px;">
                ...
                sel();>
                                                                  ...
                                                                  <td class="lable">网络类型：</td>
                              		                          <td >
                                                                       <select id="nettype" multiple="multiple" size="3" name="nettype">
                                                                             <option value="ct" selected=selected>电信</option>
								             <option value="cnc" selected=selected>网通</option>
                                                                             <option value="mobile" selected=selected>移动</option>
                                                                        </select>                                                                              
							  	   </td>                                                                                                                                
										<td>IP：</td>
									<td>
										<input name="ip" id="ip" type="text" style="width:180px;" >
									</td>
									<td>TTL：</td>

									<td>
										<input name="ttl" id="ttl" type="text" value="300" style="width:80px;">
									</td>
						...
						<div class="search_right">
							<input type="button" value="添加" class="button" onclick="add()" style="display:block;"/>	

                            <input type="button" value="查询" class="button" onclick="sel()" style="display:block;margin-top:5px;"/>						
						</div>
				...
				<div class="content">
					...
					<div class="table1">
						<table id="dns_table">
							<tr>
								<th width="30px" >序号</th>
								<th width="105px" >主域名</th>
								<th width="165px" >子域名</th>
								<th width="105px" >网络类型</th>
								<th width="105px" >TTL</th>
							<th width="65px" >IP</th>
							</tr>
