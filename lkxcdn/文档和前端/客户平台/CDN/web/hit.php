...
<script src="../js/web.hit.js" type="text/javascript"></script>
...
<script>jQuery(function(){flexMenu('box')})</script> <!--左导航结束--></div>
		<div class="main_right">
			...
			<div id="content" class="main_right_middle">
				...
				<div class="tab">
					<ul>
					   <li class="YKTabsOn"><a href="#">请求数统计</a></li>
						   	
						  	  <li><a href="pv.php">PV统计</a></li>
				...
				<div class="search">
					...
					<div id="_hit_piechart_container" style="height: 320px;">
  
					</div>

						<div style="line-height:30px;float:right;height:100%;text-align:center;width: 339px;">
			<!--				为客户节省源站请求数:<span id="reduce_count" style="color:red"></span>%
											<img id="tt_save_requests_id" src="data:image/png;base64,">
					
							<script>$(document).ready(function(){$("#tt_save_requests_id").tooltip({position:"bottom center",tip:"#tt_requests_flow"})});</script>
						-->	
						</div>
					</div>
					...
					<div class="content">
						<div class="subtitle">请求数按时间统计</div>
						<div id="_container" style="height:360px">
					...
					<div class="content">
						<div class="subtitle">
							<h2>TOP10 省份按请求数排行 </h2>
						</div>
						<div class="table">
							<table id="_province_table">
								<tr>
									<th width="30px" class="index">序号</th>
									<th width="180px">省份名称</th>
									<th width="220px">请求数值</th>
									<th class="last">请求数比例</th>
								</tr>
