...
<script src="../js/web.pv.js" type="text/javascript"></script>
...
<script>jQuery(function(){flexMenu('box')})</script> <!--左导航结束--></div>
		<div class="main_right">
			...
			<div id="content" class="main_right_middle">
				...
				<div class="tab">
					<ul>
						<li><a href="hit.php">请求数统计</a></li>
				   		<li class="YKTabsOn"><a href="#">PV统计</a></li>
			      	</ul>
				</div>
				<div class="search">
					<form>
					...
					<div class="content">
						<div class="subtitle">PV按时间统计</div>
						<div id="pv_columnchart_container" style="height:400px"></div>

						<div class="table">
							<table id="pv_table">
								<tr>
									<th width="260px" class="index">日期/时间</th>
									<th width="140px">PV（次）</th>
									<th class="last">&nbsp;</th>
								</tr>
								
								
									<tr class="evenrow">
										<td class="index">总计</td>
										<td width="140px">0</td>
										<th class="last">&nbsp;</th>
									</tr>
					...
					<div class="content">
						<div class="subtitle">
							<h2>TOP10 省份按PV排行</h2>
							<span class="note">(点击省份查看城市信息！)</span>
						...
						<div class="table">
							<table id="_province_table">
								<tr>
									...
									<th width="220px">PV值</th>
									<th class="last">PV比例</th>
								</tr>
