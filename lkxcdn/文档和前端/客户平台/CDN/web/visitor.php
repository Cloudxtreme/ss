...
<script src="../js/web.visitor.js" type="text/javascript"></script>
...
<div class="tab" id="menuDIV1">
	<ul id="menuUL1">
       	<li class='YKTabsOn'><a href='javascript:void()'>访客分析</a></li>
							...
							<table>
								<tr>
									...
									<td class="region">
										...
										<!--
<script>$(document).ready(function(){$("select[id='regionSimpleCode']").val(["cn"]);$("select[id='regionSimpleCode']").multiselect({multiple:false,selectedList:1,header:lang.multiselect.region.header,checkAllText:lang.multiselect.region.checkAllText,uncheckAllText:lang.multiselect.region.uncheckAllText,noneSelectedText:lang.multiselect.region.noneSelectedText,selectedText:lang.multiselect.region.selectedText,click:function(){$(this).multiselect("close");},minWidth:126});;});</script>
-->
								...
								<tr>
									...
									<td class="channel">
										<select id="channel" multiple="multiple" size="1" name="selectedChannels">
...
-->
					...
					<div class="content">
						<div class="subtitle">独立ip按时间统计
							
								<img id="tt_ip_type" src="data:image/png;base64,">
							<script>$(document).ready(function(){$("#tt_ip_type").tooltip({position:"top center",tip:"#tt_ip"})});</script>
						</div>

						<div id="_ip_columnchart_container" style="height:400px"></div>
						...
						<div class="table">
							<table id="_ip_table">
								<tr>
									...
									<th width="180px">归属地</th>
									<th width="220px">请求数(次)</th>
									<th class="last">流量(KB)</th>
								</tr>
