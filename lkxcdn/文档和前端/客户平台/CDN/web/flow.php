...
<script src="../js/web.flow.js" type="text/javascript"></script>
	  ...
	  <li class='YKTabsOn'><a href='javascript:void()'>流量统计</a></li>
				...
				<div class="search">
					...
					<div class="content">
						...
						<div  id="flowAllPieChart_container" style="height: 320px;">
							</div>
	
						<div style="line-height:30px;float:right;height:100%;text-align:center;width: 439px;">
							注：src代表回源流量；node代表节点流量，即为客户节省的流量
					<!--		为客户节省源站流量:0.00%-->
											<img id="tt_save_flow_id" src="data:image/png;base64,">
							<script>$(document).ready(function(){$("#tt_save_flow_id").tooltip({position:"bottom center",tip:"#tt_save_flow"})});</script>
						</div>
					</div>
