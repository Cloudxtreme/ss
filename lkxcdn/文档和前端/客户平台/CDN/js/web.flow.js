			$(function(){
				 check_login_user_acc( $("#_login_type").val(),'web', 3, 32 );
			   ...
			   $.post("../function/web.flow.fun.php",{ "user":user,"get_type":settype },function(data){
			   			var arr = data.split("***");
			   		  var zone = eval("("+arr[1]+")");
      	 ...
      	 var getOffDays =  mmSec / 3600000 / 24; 
			   ...
			   for( i = 0; i < channel.length; i++ ){     
			    ...
			    $.post("../function/web.flow.fun.php",{"user":user,"get_type":settype,"time":time_str,"channel":channel_str,"zone":zone_str},function(data){
			    		   var arr = data.split("***");
