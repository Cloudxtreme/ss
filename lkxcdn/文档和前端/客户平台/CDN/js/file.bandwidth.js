			$(function(){
				 check_login_user_acc( $("#_login_type").val(), 'file', 4, 41 );
			   ...
			   $.post("../function/file.bandwidth.fun.php",{"user":user,"get_type":settype},function(data){
			   			var arr = data.split("***");
			   		  var zone = eval("("+arr[1]+")");
			...
			function query(){
			   ...
			   for( i = 0; i < channel.length; i++ ){     
			    ...
			    $.post("../function/file.bandwidth.fun.php",{"user":user,"get_type":settype,"time":time_str,"channel":channel_str,"zone":zone_str,"isp":isp_str},function(data){
			    		var chartData = [];
			    		var arr = data.split("***");
			    		arr_time = eval("("+arr[0]+")");
