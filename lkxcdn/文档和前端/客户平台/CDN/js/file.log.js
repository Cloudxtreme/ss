		$(function(){
		     check_login_user_acc( $("#_login_type").val(),'file', 4, 47 );
				 var user = get_login_user();
			   var  url = "http://filelogdw.cdn.efly.cc/cdn_file_log/base.log.fun.php?client="+user+"&callback=?";
