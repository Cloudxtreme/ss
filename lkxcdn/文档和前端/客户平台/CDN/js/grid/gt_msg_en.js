...
Sigma.Msg.Grid['en']=Sigma.Msg.Grid.en;
...
Sigma.Msg.Validator.en={
		...
		'gt_minlength'	: '{0} must contain more than {1} characters.',
		'gt_maxlength'	: '{0} must contain less than {1} characters.'

}

Sigma.Msg.Validator['en'] = Sigma.Msg.Validator.en;
//