...
$.widget("ech.multiselect", {
	...
	options: {
		...
		minWidth: 225,
		classes: '',
		checkAllText: lang.multiselect.checkAllText || 'Check all',
		uncheckAllText: lang.multiselect.uncheckAllText || 'Uncheck all',
	...
	_setMenuWidth: function(){
		var m = this.menu,o = this.options,
		...
		// 可指定宽度		
		m.width( o.optionWidth || width || this.button.outerWidth() );
	},
	...
	open: function(e){
		...
		if($.browser.msie&&($.browser.version=='6.0')&&!$.support.style){
			...
			$container.scrollTop(0).height('auto');
