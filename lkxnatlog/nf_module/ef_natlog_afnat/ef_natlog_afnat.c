...
#endif
{
	...
	*/
	...
	nf_log_packet(NFPROTO_IPV4, hooknum, sb, in, out, NULL, "efly_afnat");
#else
	nf_log_packet(PF_INET, hooknum, sb, in, out, NULL, "efly_afnat");
#endif
...
int init_module()
{
	...
	printk("[AFNAT] NAT_SLOT:%d NAT_TYPE:%d ENABLE_IPSTATENEW:%d\n", 
